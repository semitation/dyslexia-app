  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-soft-50 via-white to-warm-50 font-dyslexic flex flex-col">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Slider
                        ...
                        className="w-full"
                      />
                      <p className="text-xs text-gray-600">{lineSpacing[0].toFixed(1)}</p>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Slider
                        ...
                        className="w-full"
                      />
                      <p className="text-xs text-gray-600">{(letterSpacing[0] * 100).toFixed(0)}%</p>
                    </div>
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <Card className={`border-gray-200 shadow-lg ${backgroundColors[backgroundColor as keyof typeof backgroundColors]} ${readingFocusMode ? 'reading-focus' : ''}`}>
              ...
              >
                {mockContent.split('\n\n').slice(0, 2).map((paragraph, index) => (
                  <p key={index} className="mb-4">
                    {paragraph.trim().split(' ').map((word, wordIndex) => (
                      <span
                        key={wordIndex}
