          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                ...
                <div>
                  <h4 className="font-medium text-yellow-800">카카오톡으로 전달</h4>
                  <p className="text-sm text-yellow-700 mt-1">
                    1. 카카오톡을 열고 학생과의 채팅방으로 이동하세요<br/>
              ...
              <div className="flex items-start space-x-3 p-4 bg-green-50 border border-green-200 rounded-lg">
                ...
                <div>
                  <h4 className="font-medium text-green-800">문자 메시지로 전달</h4>
                  <p className="text-sm text-green-700 mt-1">
                    1. 문자 메시지 앱을 열고 학생의 연락처를 선택하세요<br/>
                    2. 복사한 링크를 붙여넣기하여 전송하세요
                  </p>
                </div>
              </div>
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm text-amber-800">
                  <strong>안내:</strong> 학생이 이 링크를 통해 회원가입하면 자동으로 연결됩니다.
                </p>
              </div>
            </div>
          </div>
