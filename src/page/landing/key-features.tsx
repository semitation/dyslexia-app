  ...
  const features = [
    {
      ...
      details: "단어 난이도 조절, 문장 구조 단순화, 이미지 자동 생성 기능으로 아이의 읽기 이해를 돕습니다.",
      example: (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-gray-50 p-4 rounded-lg">
            <h6 className="text-sm font-medium text-gray-600 mb-2">원문 (영어)</h6>
            <p className="text-sm text-gray-800">"The quick brown fox jumps over the lazy dog."</p>
          </div>
    ...
    },
    {
      ...
      description: "학습 상태와 이해도를 실시간으로 확인하고 피드백을 제공할 수 있어요.",
      details: "",
      example: (
        <div className="space-y-4">
          <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-400">
            <div className="flex justify-between items-center text-sm">
              <span className="font-medium text-green-800">민지의 학습 상태</span>
          ...
          <div className="bg-yellow-50 p-4 rounded-lg border-l-4 border-yellow-400">
            <div className="flex justify-between items-center text-sm">
              <span className="font-medium text-yellow-800">준호의 학습 상태</span>
    ...
    },
    {
      ...
      description: "읽기 선호도, 학습 패턴 등을 기반으로 맞춤형 교육을 제공합니다.",
      details: "",
      example: (
    ...
    <section className="w-full px-4 py-20 bg-[#F8FBFF]">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <Typography variant="h2" size="2xl" weight="bold" className="text-gray-900 mb-4">
            리딩브릿지의 핵심 기능
          </Typography>
          ...
          {features.map((feature, idx) => (
            ...
            >
              <div className="flex-1">
                ...
                <p className="text-lg text-gray-700 mb-2 leading-relaxed">{feature.description}</p>
                <p className="text-gray-600 leading-relaxed">{feature.details}</p>
              </div>
              <div className="flex-1 bg-white p-6 rounded-2xl border border-gray-100 shadow-lg">
                {feature.example}
              </div>
            </div>
          ))}
