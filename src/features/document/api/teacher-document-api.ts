...
export const teacherDocumentApi = {
  list: async (teacherId: number): Promise<TeacherDocumentSummaryListResponseDto> => {
    return (await axiosClient.get(`/teacher/documents/${teacherId}`)) as unknown as TeacherDocumentSummaryListResponseDto;
  },
};
