...
export function parseBlocks(
    ...
    return blocks.map((block, i) => {
		...
		switch (block.type) {
            ...
            case 'DOTTED':
                return (
                    <ul key={key} className={cn('list-disc pl-8 mb-4', fontClass)} style={baseStyle}>
            ...
            case 'PAGE_IMAGE':
                return (
                    <figure key={key} className={cn('mb-8 mt-4 flex flex-col', fontClass)}>
            ...
            case 'TABLE':
                return (
                    <div key={key} className="overflow-x-auto mb-4">
                        <table className={cn('min-w-full border text-sm', fontClass)} style={baseStyle}>
                            <thead>
                                <tr>
